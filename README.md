...
- lot of activation functions: Asinh, Atan, Bent, Elliot, Elu, Exponential, Gauss, HardELU, HardSigmoid, ISRELU, Linear, LeakyRelu, LeakyRelu256, TwiceLeakyRelu6, NLRelu, Parablu, Relu, Relu6, Selu, SQNL, SoftPlus, Sin, SinC, Sigmoid, Swish, SoftSign, Tanh
