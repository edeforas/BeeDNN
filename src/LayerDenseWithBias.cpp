...
///////////////////////////////////////////////////////////////////////////////
LayerDenseWithBias::LayerDenseWithBias(int iInSize,int iOutSize):
...
///////////////////////////////////////////////////////////////////////////////
LayerDenseWithBias::~LayerDenseWithBias()
{ }
///////////////////////////////////////////////////////////////////////////////
void LayerDenseWithBias::init()
{
...
///////////////////////////////////////////////////////////////////////////////
void LayerDenseWithBias::forward(const MatrixFloat& mMatIn,MatrixFloat& mMatOut) const
{
    mMatOut= mMatIn*_weight + _bias;
}
///////////////////////////////////////////////////////////////////////////////
void LayerDenseWithBias::backpropagation(const MatrixFloat &mInput,const MatrixFloat &mDelta, float fLearningRate, MatrixFloat &mNewDelta)
{
