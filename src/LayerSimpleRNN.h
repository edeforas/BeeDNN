...
public:
    ...
    virtual void forward_sample(const MatrixFloat& mIn, MatrixFloat& mOut) override;
    virtual void backpropagation_sample(const MatrixFloat& mIn, const MatrixFloat& mGradientOut, MatrixFloat& mGradientIn) override;
